...
class TestTradingEngine:
    ...
    def test_update_positions(self, trading_engine):
        ...
        trading_engine.broker.check_stop_loss.assert_called_once_with(
    ...
    def test_execute_trading_cycle_success(self, mock_validate, mock_signals, 
                                          mock_atr, mock_fetch, trading_engine):
        """测试成功执行交易周期"""
        symbol = "BTCUSDT"
        
        # 设置模拟返回值
        mock_fetch.return_value = [100.0, 101.0, 102.0, 103.0, 104.0]
