...
class TestStrategyRefactoring(unittest.TestCase):
    ...
    def test_strategy_imports(self):
        ...
        from src.strategies import (
            SimpleMAStrategy, ExponentialMAStrategy, TripleMAStrategy, ImprovedMAStrategy,
            RSIStrategy, MACDStrategy, StochasticStrategy, WilliamsRStrategy,
            BollingerBreakoutStrategy, BollingerMeanReversionStrategy,
            ChannelBreakoutStrategy, DonchianChannelStrategy, ATRBreakoutStrategy,
            TrendFollowingStrategy, MultiTimeframeStrategy, AdaptiveMovingAverageStrategy,
            SupertrendStrategy, ALL_STRATEGIES
        )
    ...
    def test_moving_average_strategies(self):
        ...
        from src.strategies.moving_average import SimpleMAStrategy, ImprovedMAStrategy
        ...
        improved_strategy = ImprovedMAStrategy(
    ...
    def test_oscillator_strategies(self):
        ...
        from src.strategies.oscillator import RSIStrategy, MACDStrategy
    ...
    def test_breakout_strategies(self):
        ...
        from src.strategies.breakout import BollingerBreakoutStrategy, ATRBreakoutStrategy
    ...
    def test_trend_following_strategies(self):
        ...
        from src.strategies.trend_following import TrendFollowingStrategy, SupertrendStrategy
    ...
    def test_backward_compatibility(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            deprecated_warnings = [warning for warning in w if "deprecated" in str(warning.message).lower()]
            self.assertTrue(len(deprecated_warnings) > 0, f"Expected deprecation warnings but got: {[str(w.message) for w in w]}")
...
class TestMonitoringRefactoring(unittest.TestCase):
    ...
    def test_monitoring_imports(self):
        ...
        from src.monitoring import (
            PrometheusExporter, MetricsCollector, HealthChecker, AlertManager
        )
    
        # Test basic instantiation with isolated registry
        custom_registry = CollectorRegistry()
        exporter = PrometheusExporter(port=9091, registry=custom_registry)  # Use different port and registry
    ...
    def test_monitoring_backward_compatibility(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            custom_registry = CollectorRegistry()
            exporter = PrometheusExporter(port=9094, registry=custom_registry)  # Use isolated registry
            self.assertIsNotNone(exporter)
