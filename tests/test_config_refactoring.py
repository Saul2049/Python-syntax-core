...
""")
    ...
    def test_default_config(self):
        ...
        required_keys = [
            ...
            'account_equity', 'log_level', 'monitoring_port'
        ]
    ...
    def test_config_priority(self):
        ...
        config = TradingConfig(
            config_file=self.config_ini_path,
            config_yaml=self.config_yaml_path
        )
    ...
    def test_config_methods(self):
        ...
        methods_to_test = [
            'get_symbols', 'get_risk_percent', 'get_fast_ma', 'get_slow_ma',
            'get_atr_period', 'get_check_interval', 'is_test_mode',
            'get_account_equity', 'get_api_credentials', 'get_telegram_config',
            'get_log_level', 'get_log_dir', 'get_trades_dir',
            'use_binance_testnet', 'get_monitoring_port', 'is_monitoring_enabled'
        ]
