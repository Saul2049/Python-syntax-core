...
class W1QuickTest:
    ...
    def compare_results(self, baseline: Dict, optimized: Dict) -> Dict:
        ...
        allocation_improvement = (baseline['allocation_count'] - optimized['allocation_count']) / baseline['allocation_count'] * 100
    ...
    def run_full_test(self):
        ...
        if self.fast_mode:
            # FAST模式简化输出
            print(f"📊 结果: RSS {comparison['optimized_rss_delta']:+.1f}MB, 分配改善 {comparison['allocation_improvement_pct']:.0f}%")
