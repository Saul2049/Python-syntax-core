...
class StabilityTest:
    ...
    def setup_trading_system(self):
        ...
        try:
            ...
            self.market = MarketSimulator(symbols=self.symbols, initial_balance=10000.0, fee_rate=0.001)
...
def main():
    ...
    parser.add_argument("--symbols", type=str, default="BTC/USDT,ETH/USDT", help="要测试的交易对，用逗号分隔")
    parser.add_argument("--days", type=int, default=3, help="测试持续天数")
    parser.add_argument("--interval", type=int, default=60, help="检查间隔(秒)")
    parser.add_argument("--risk", type=float, default=0.5, help="风险百分比")
    parser.add_argument("--log-dir", type=str, default="logs/stability_test", help="日志目录")
