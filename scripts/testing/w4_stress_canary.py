...
class W4StressCanary:
    ...
    async def initialize_test_environment(self):
        ...
        self.logger.info(f"✅ 测试环境初始化完成 - 交易对: {self.pairs}, 频率: {self.frequency_hz}Hz")
    ...
    async def run_high_frequency_load(self):
        ...
        while self.test_running:
            ...
            if sleep_time > 0:
                ...
                self.logger.warning(f"⚠️ 处理延迟过高: {elapsed*1000:.1f}ms (目标: {interval*1000:.1f}ms)")
    ...
    async def _collect_system_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # 性能统计
            recent_samples = [s for s in self.performance_samples 
            ...
            return {
                ...
                'performance': {
                    ...
                    'operations_per_second': len(recent_samples) * len(self.pairs) / 3600 if recent_samples else 0
                },
    ...
    async def _send_alert(self, alert: Dict[str, Any]):
        ...
        violations_summary = ", ".join([
            f"{v['threshold']}={v['current']:.1f}>{v['limit']}" 
    ...
    async def generate_hourly_report(self):
        ...
        while self.test_running:
            ...
            hour_samples = [s for s in self.performance_samples 
            ...
            hour_report = {
                ...
                'performance_summary': {
                    ...
                    'error_rate': sum(s['error_count'] for s in hour_samples) / max(1, len(hour_samples))
                },
            ...
            self.logger.info(f"📊 第{hours_completed}小时报告完成 - 状态: {hour_report['w4_status']}")
    ...
    async def _generate_final_report(self) -> Dict[str, Any]:
        ...
        # 统计告警
        critical_alerts = [a for a in self.alerts if any(v.get('severity') == 'critical' for v in a.get('violations', []))]
        ...
        if self.performance_samples:
            ...
            performance_stats = {
                ...
                'operations_per_second': len(self.performance_samples) * len(self.pairs) / (runtime_hours * 3600)
            }
        else:
            performance_stats = {}
    ...
    def _evaluate_w4_success(self, report: Dict[str, Any]) -> bool:
        ...
        criteria = {
            ...
            'final_rss_acceptable': (
                report['final_metrics']['memory']['rss_mb'] <= 
                self.w4_thresholds['max_rss_mb']
            )
        }
...
async def main():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('w4_stress_canary.log'),
