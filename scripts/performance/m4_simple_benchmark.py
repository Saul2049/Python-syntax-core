...
class M4SimpleBenchmark:
    ...
    async def benchmark_async_signal_processing(self) -> Dict[str, Any]:
        ...
        if signal_times:
            ...
            p95_latency = statistics.quantiles(signal_times, n=20)[18] if len(signal_times) >= 20 else max(signal_times)
    ...
    async def benchmark_concurrent_cpu_usage(self) -> Dict[str, Any]:
        ...
        await asyncio.gather(
            cpu_monitor(),
            high_frequency_signal_processing(), 
    ...
    async def benchmark_async_task_scheduling(self) -> Dict[str, Any]:
        ...
        if task_latencies:
            ...
            p95_latency = statistics.quantiles(task_latencies, n=20)[18] if len(task_latencies) >= 20 else max(task_latencies)
