    ...
    def __init__(
        ...
        self.config = {
            "trading": {
                ...
                "check_interval": 60,
                "test_mode": True,
                "indicators": {"fast_ma": 7, "slow_ma": 25, "atr_period": 14},
            },
            "data_sources": {
    ...
    def save_yaml_config(self, config_yaml: Optional[str] = None) -> bool:
        ...
        try:
            ...
            with open(config_yaml, "w", encoding="utf-8") as f:
                yaml.dump(
                    config_to_save, f, default_flow_style=False, sort_keys=False, allow_unicode=True
                )
...
def get_config(config_yaml=None, env_file=None, config_ini=None) -> EnhancedConfigManager:
    ...
    if _config_manager is None:
        _config_manager = EnhancedConfigManager(
            config_yaml=config_yaml, env_file=env_file, config_ini=config_ini
        )
