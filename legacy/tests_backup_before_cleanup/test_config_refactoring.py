...
class TestConfigRefactoring(unittest.TestCase):
    ...
    def test_ini_config_loading(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            config_ini_path = os.path.join(temp_dir, "test_config.ini")
...
"""
            ...
            config = TradingConfig(config_file=config_ini_path)
    ...
    def test_yaml_config_loading(self):
        ...
        # 🧹 使用临时目录上下文管理器
        with tempfile.TemporaryDirectory() as temp_dir:
            config_yaml_path = os.path.join(temp_dir, "test_config.yaml")
...
"""
            ...
            config = TradingConfig(config_yaml=config_yaml_path)
...
"""
            ...
            config = TradingConfig(config_file=config_ini_path, config_yaml=config_yaml_path)
...
"""
            ...
            config1 = get_config(config_file=config_ini_path)
            ...
            # Force new instance
            reset_config()
            config3 = get_config(config_file=config_ini_path, use_cache=False)
