...
class TestRetryManager:
    ...
    def test_create_retry_decorator_basic(self):
        """测试创建重试装饰器基本功能"""
        decorator = create_retry_decorator(retry_config={"max_retries": 2, "base_delay": 0.01})
    ...
    def test_retry_manager_execute_with_retries(self, mock_sleep):
        ...
        result = manager.execute_with_retry(func, "test_arg", retry_on_exceptions=[Exception])
...
class TestStateManager:
    ...
    def test_state_manager_save_load_state(self):
        ...
        # 测试数据
        test_data = {"operation": "test", "status": "completed", "value": 123}
