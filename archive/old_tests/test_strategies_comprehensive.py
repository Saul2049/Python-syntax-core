...
from src.strategies.breakout import BollingerBreakoutStrategy, ChannelBreakoutStrategy, DonchianChannelStrategy
...
class TestBacktestExecutor:
    ...
    def test_backtest_portfolio_function(self, sample_ohlcv_data):
        ...
        try:
            ...
            # 创建多资产数据
            portfolio_data = {
                'ASSET1': sample_ohlcv_data,
                'ASSET2': sample_ohlcv_data.copy()
            }
...
class TestStrategiesIntegration:
    ...
    def test_strategy_backtest_integration(self, sample_ohlcv_data, mock_position_manager, mock_risk_manager):
        """测试策略与回测的集成"""
        # 创建移动平均策略
    ...
    def test_multiple_strategies_comparison(self, sample_ohlcv_data):
        ...
        # 创建不同策略
        strategies = [
            SimpleMAStrategy(short_window=5, long_window=15),
