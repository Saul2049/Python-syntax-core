...
class TestFetchPriceData:
    ...
    def test_fetch_price_data_with_exchange_client_success(self):
        ...
        mock_client = Mock()
        mock_klines = [
            [1640995200000, "50000", "50500", "49500", "50200", "100.5", 1640998799999, 
             "5025000", 1000, "50.25", "2512500", "0"],
            [1640998800000, "50200", "50800", "49800", "50600", "120.3", 1641002399999,
             "6090000", 1200, "60.15", "3045000", "0"],
        ]
    ...
    def test_fetch_price_data_without_exchange_client(self):
        ...
        with patch("src.brokers.binance.BinanceClient") as mock_binance:
            ...
            mock_client.get_klines.return_value = [
                [1640995200000, "30000", "30500", "29500", "30200", "50.0", 1640998799999,
                 "1510000", 500, "25.0", "755000", "0"]
            ]
    ...
    def test_fetch_price_data_with_real_data_format(self):
        ...
        # 模拟真实的币安API响应格式
        mock_klines = [
            ["1640995200000", "50000.00", "50500.50", "49500.25", "50200.75", "100.50000000",
             "1640998799999", "5025000.00000000", "1000", "50.25000000", "2512500.00000000", "0"],
        ]
        mock_client.get_klines.return_value = mock_klines
    ...
    def test_fetch_price_data_multiple_symbols(self):
        ...
        for symbol in symbols:
            mock_client.get_klines.return_value = [
                [1640995200000, "100", "105", "95", "102", "50", 1640998799999,
                 "5000", 100, "25", "2500", "0"]
            ]
