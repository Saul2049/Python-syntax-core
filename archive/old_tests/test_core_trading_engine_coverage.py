...
class TestTradingCycleExecution:
    ...
    @patch("src.core.trading_engine.get_trading_signals")
    @patch("src.core.trading_engine.validate_signal")
    def test_execute_trading_cycle_invalid_signal(self, mock_validate, mock_signals, mock_atr, mock_price):
        """测试信号验证失败的情况"""
        symbol = "BTCUSDT"
    ...
    @patch("src.core.trading_engine.get_trading_signals")
    @patch("src.core.trading_engine.validate_signal")
    def test_execute_trading_cycle_stop_triggered(self, mock_validate, mock_signals, mock_atr, mock_price):
        """测试止损触发的情况"""
        symbol = "BTCUSDT"
