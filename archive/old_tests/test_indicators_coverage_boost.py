    ...
    def test_williams_r_calculation(self):
        ...
        try:
            ...
            williams_r = calculate_williams_r(
                self.test_data["high"], self.test_data["low"], self.test_data["close"], period=14
            )
    ...
    def test_atr_calculation(self):
        ...
        try:
            ...
            atr_values = calculate_atr(
                self.test_data["high"], self.test_data["low"], self.test_data["close"], window=14
            )
...
class TestTechnicalAnalysisIndicators(unittest.TestCase):
    ...
    def test_trend_indicators(self):
        ...
        try:
            from src.data.indicators.technical_analysis import calculate_adx, calculate_aroon
    ...
    def test_volume_indicators(self):
        ...
        try:
            from src.data.indicators.technical_analysis import calculate_obv, volume_price_trend
            ...
            try:
                vpt = volume_price_trend(self.market_data["close"], self.market_data["volume"])
        ...
        try:
            ...
            try:
                pivot_points = calculate_pivot_points(
                    self.market_data["high"], self.market_data["low"], self.market_data["close"]
                )
...
class TestImprovedStrategyModule(unittest.TestCase):
    ...
    def test_strategy_classes_exist(self):
        ...
        try:
            ...
            # 验证类可以实例化
            strategies = [BuyAndHoldStrategy, TrendFollowingStrategy, ImprovedMACrossStrategy]
    ...
    def test_trend_following_strategy(self):
        ...
        try:
            ...
            strategy = TrendFollowingStrategy(ma_window=20, atr_window=14, multiplier=2.0)
    ...
    def test_ma_cross_strategy(self):
        ...
        try:
            ...
            strategy = ImprovedMACrossStrategy(initial_equity=10000, short_window=5, long_window=15)
            result = strategy.run_backtest(self.test_market_data)
